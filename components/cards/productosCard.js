...
import datos from './../../pages/api/productos/index.json';
            ...
            <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
                ...
                <FormControl variant="outlined" fullWidth sx={{ backgroundColor: "white" }}>
                    ...
                    >
                        ...
                        <MenuItem value="Sustratos y suelos">Sustratos y suelos</MenuItem>
                        <MenuItem value="Fertilizantes y enmiendas">Fertilizantes y enmiendas</MenuItem>
                        <MenuItem value="Herramientas">Herramientas</MenuItem>
                        <MenuItem value="Decoración de jardines">Decoración de jardines</MenuItem>
                        <MenuItem value="Contenedores y macetas">Contenedores y macetas</MenuItem>
                        <MenuItem value="Control de plagas y enfermedades">Control de plagas y enfermedades</MenuItem>
